...
return [
	...
	*/
	...
	/* page title start */
		...
		'guest_income_report_between_date' => 'Guest income report between date',
		/* Report page end */

		/*Dashboars start*/
		'pending_rent_count' => 'Pending rent count',
		'pending_rent_amount' => 'Pending rent',
		'overall_pending_guests' => 'Overall pending rent count',
		'overall_pending_rent' => 'Overall pending rent',
		'total_expenses' => 'Total expenses',
		'total_incomes' => 'Total incomes',
		'overall_total_expenses' => 'Overall expenses',
		'overall_total_incomes' => 'Overall incomes',
	...
	/* label name start */
		...
		/* Room report label end */
		'monthly_rent_amount' => 'Monthly rent amount',
		'monthly_income_amount' => 'Monthly income amount',
