...
@section('main-content')
  ...
  <div class="col-md-6 col-lg-3">
    <div class="widget-bg-color-icon card-box fadeInDown animated">
      ...
      <div id="overalIncomeProgress" class="progress-css"></div>
      <div class="text-right">
        <h3 class="text-dark"><b>&#8377;&nbsp;</b><b class="incrementCounter">0</b></h3>
        <p class="text-muted">{{trans('message.overall_total_incomes')}}</p>
      </div>
      <div class="clearfix"></div>
    </div>
  </div>
  <div class="col-md-6 col-lg-3">
    <div class="widget-bg-color-icon card-box fadeInDown animated">
      ...
      <div id="overalExpenseProgress" class="progress-css"></div>
      <div class="text-right">
        <h3 class="text-dark"><b>&#8377;&nbsp;</b><b class="incrementCounter">0</b></h3>
        <p class="text-muted">{{trans('message.overall_total_expenses')}}</p>
      </div>
      <div class="clearfix"></div>
    </div>
  </div>
  <div class="col-md-6 col-lg-3">
    <div class="widget-bg-color-icon card-box fadeInDown animated">
      ...
      <div id="overallRentProgress" class="progress-css"></div>
      <div class="text-right">
        <h3 class="text-dark"><b>&#8377;&nbsp;</b><b class="incrementCounter">0</b></h3>
        <p class="text-muted">{{trans('message.overall_pending_rent')}}</p>
      </div>
      <div class="clearfix"></div>
    </div>
  </div>
  <div class="col-md-6 col-lg-3">
    <div class="widget-bg-color-icon card-box">
      ...
      <div id="overallGuestsProgress" class="progress-css"></div>
      <div class="text-right">
        <h3 class="text-dark"><b></b><b class="incrementCounter">0</b></h3>
        <p class="text-muted">{{trans('message.overall_pending_guests')}}</p>
      </div>
      <div class="clearfix"></div>
    </div>
  </div>
...
var overall_total_income = <?php echo $overall_total_income; ?>;
var overall_total_expense = <?php echo $overall_total_expense; ?>;
var total_pending_rent = <?php echo $total_pending_rent; ?>;
var total_pending_guests = <?php echo $total_pending_guests; ?>;
var overall_pending_rent = <?php echo $overall_pending_rent; ?>;
var overall_pending_guests = <?php echo $overall_pending_guests; ?>;
